#first book store then am gonna change it to a todo application
"""
...
#Adding data
def add_command():
    engine.insert(title_text.get(), author_text.get(), year_text.get(), isbn_text.get()) #add enrty to db
